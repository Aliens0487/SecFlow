...
import (
	...
	"github.com/Aliens0487/secFlow/pkg/circuits/gmimc"
	"github.com/Aliens0487/secFlow/pkg/circuits/hkdf"
	"github.com/Aliens0487/secFlow/pkg/circuits/lifecycle"
	"github.com/Aliens0487/secFlow/pkg/circuits/mimc"
	"github.com/Aliens0487/secFlow/pkg/circuits/proofofownership"
	"github.com/Aliens0487/secFlow/pkg/circuits/utils"
	"github.com/Aliens0487/secFlow/pkg/common"
...
func (circuit Circuit) Define(api frontend.API) error {
	...
	// State changed from curr to new, but not completed
	same, complated, stateChanged := stage1(N, circuit, api)
	...
	stage2(executables, api, circuit, stateChanged, same, complated, involvedWithPayment, readyInTheRightTime, completedAndTokenForwarded)
...
func stage2(executables []*model.Node, api frontend.API, circuit Circuit, stateChanged []frontend.Variable, same []frontend.Variable, complated []frontend.Variable, involvedWithPayment []frontend.Variable, readyInTheRightTime []frontend.Variable, completedAndTokenForwarded []frontend.Variable) {
...
func stage1(N int, circuit Circuit, api frontend.API) ([]frontend.Variable, []frontend.Variable, []frontend.Variable) {
	same := make([]frontend.Variable, N)
	complated := make([]frontend.Variable, N)
	stateChanged := make([]frontend.Variable, N)
