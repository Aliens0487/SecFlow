...
func NewSecFlowProgram(modelPath string) (*SecFlowProgram, error) {
	...
	return &SecFlowProgram{
		Model:   graph,
		Circuit: &circuit,
	}, nil
}

func (secFlow *SecFlowProgram) LoadCompiled(path string) error {
