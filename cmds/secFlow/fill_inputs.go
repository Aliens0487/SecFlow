...
var fillInputsCommand = &cobra.Command{
	...
	Short: "Fill inputs for the secFlow circuit",
	Long: `Fill inputs for the secFlow circuit. It reads the input and keys from the given files and fills the input file with the appropriate values as follows:
